...
\begin{abstract}
Although people naturally rely upon multiple, diverse information sources in the course of routine problem-solving and decision-making tasks, support for data integration in Personal Information Management (PIM) tools remains poor, if largely nonexistent. This paper presents an exploratory, sequential, mixed-method study of ways to extend PIM tools to support user-driven data integration while performing their primary tasks. We present results of two pre-study in which requirements, we designed and evaluated DataPalette.  
