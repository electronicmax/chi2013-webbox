...
The second metric was the number of factors the participant considered in making their final choice. To determine this, we asked participants to explain why they made their choice(s), and recorded the number of distinct data dimensions mentioned.  An ANOVA revealed a significant effect of interface on the number of such factors mentioned; post-hoc analysis using Tukey-Schiffe adjustments indicated that participants in the DP condition mentioned significantly more dimensions in their final decisions ($M=5.5; SD=1.7$) than those in the control condition ($M=4; SD=1.73$), $F(1,19)=3.95; p<0.10$. A strong significant effect was also observed between participant ID and number of dimensions mentioned, meaning people differed significantly on the number of reasons they gave ($F(19,19)=4.53 p < 0.001$).
