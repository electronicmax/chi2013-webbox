...
\begin{abstract}
While people naturally draw upon diverse sources of information while problem solving and making decisions, tool support for serendipitous data mixing in Personal Information Management tools remains mostly absent. This paper presents an exploratory, sequential mixed-method study of user-driven data integration methods for PIM tools...
