...
A lab study showed that users understood the interaction mechanisms and the problems they were designed to address, and that it allowed them to make more carefully informed decisions and draw from more data sources while making multidimensional subjective decisions.
