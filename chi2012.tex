...
In condition B (control) the participants were given the source web site URLs, as well as a spreadsheet containing the data taken from those web sites (the same data loaded into DP for condition A). Participants were free to use the web sites and spreadsheets however they wished.
