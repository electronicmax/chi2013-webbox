...
For the first prestudy, we designed and ran a semi-structured interview to discover the processes and tools people would use when combining data from multiple websites. We interviewed 8 participants and asked them a range of questions regarding their use of multiple websites in gathering information. We then inquired as to how each participant would go about planning various aspects of a large party, such as date, location and entertainment.
