...
In this paper, we present an exploratory initial investigation of user-driven, ad-hoc data integration approaches for PIM, towards enabling greater use of emerging ecosystem of structured data available on the Web.
...
These observations led to the design of DataPalette, an interface for ``light-touch'' data integration that introduced drag-and-drop and path-selection mechanisms for managing collections of terminologically and structurally-heterogeneous data.
Our lab study of DataPalette with actual data obtained from a selection of Web sites  showed that users understood the interaction mechanisms introduced and the problems they were designed to address, and that DesignPalette allowed them to make more carefully informed decisions and draw from more data sources while performing multidimensional subjective choice-based tasks.
