...
Just as the wise Italian in Voltaire's poem \emph{La Begueule} predicted,``the best is the enemy of the good'', we believe that the quest for complete approaches to data integration have perhaps caused more scruffy, ``ad-hoc'' approaches to be overlooked.  Based upon the results of our investigation, we see a number of benefits to user-driven data reconciliation approaches over automatic and bespoke ones.  Specifically, letting the user freely merge and split data as part of his or her sensemaking process, gives users the power to see data combined or split up as best suited to the task
