...
\begin{abstract}
%% While people often draw upon diverse sources of information in the course of common tasks, tool support for integrating information from diverse information sources remains scarce. This paper presents an exploratory, sequential mixed-method study of user-driven data integration methods for PIM tools...
