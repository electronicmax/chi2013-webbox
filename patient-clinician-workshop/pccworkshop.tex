...
\subsection{Automatic activity sensing and digital well-being}
...
been driven by both the falling costs of embeddable electronics, and
the demand for self-measurement from the ``quantified-self''\cite{}
movement.  Wireless sensors such as the Fit-bit\cite{} and Nike
FuelBand\cite{} and small, discreet, and low-cost, providing the
wearer with high-resolution temporal data about their activity levels,
...
The data collected by patients' devices has the potential to create a large volume of data, and therefore particular
