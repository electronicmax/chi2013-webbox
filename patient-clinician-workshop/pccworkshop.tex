...
The high-resolution data collected by activity-sensing devices, accumulated over a long period such as a patient's lifespan, can result in a substantially greater volume of data than current EHR platforms are designed to handle. To this challenge we present our own personal data platform ``WebBox \cite{webbox}.'' We have used WebBox with EHRs
