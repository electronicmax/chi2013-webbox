...
Since SNOWMED-CT nor ICD cover concepts pertaining to routine measured activity, we are devising a supplemental ontology for these concepts we call \emph{Activity-SENSE}.  This ontology encompasses patient activities, standard units of measure with which these activities are measured, and the ability to describe how and what kinds of sensors were used to sense the activity measured.  The intention is for Activity-SENSE records to, like those of SNOMED-CT, eventually be translatable to different languages and mapped to other similiar ontologies of behaviour.
...
To this challenge we present our own personal data platform ``WebBox \cite{webbox}.'' We have used WebBox with EHRs
to enable patient collected data to be augmented with hospital-provided EHR data. WebBox is able to combine
data from multiple sources, and enables patients to make their own annotations against data, and
to optionally share these annotations, along with their activity diaries, with their clinician. This
then enables clinicians and patients to enter into a dialog about how well the patient is doing,
and any lifestyle changes they can make to better their situation.
...
Nigel Shadbolt (FBCS FREng) is Professor of Artificial Intelligence and Head of the Web and Internet Science Group, Electronics and Computer Science, University of Southampton. He is the Chairman and Co-Founder of the Open Data Institute, Director of the Web Science Trust, and of the Web Foundation. In 2009 the Prime Minister appointed him and Sir Tim Berners-Lee as Information Advisors to transform access to Public Sector Information, leading to the highly acclaimed data.gov.uk. He is a member of the Public Sector Transparency Board, overseeing Open Data releases across the public sector. He is Chair of the UK Government’s midata programme, which seeks to empower consumers by releasing their data back to them.
