...
\copyrightinfo{
  ...
  \emph{ACM CHI 2013}, April 28, 2013, Paris, France.\\
...
We posit that significant gains in patient-clinician communications can be made by helping clinicians to better understand a patient's life between their visits to the doctor. In this paper, we propose a mechanism for augmenting electronic health records with \emph{personal activity diaries}, high-resolution records of a patient's daily life, derived automatically from personal activity sensors.  These activity diaries establish a shared context for discussing the patient's lifestyle and condition.
