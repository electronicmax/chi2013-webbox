...
The data collected by patients' devices has the potential to create a large volume of highly structured data. This is in contrast to
EHRs which tend to contain individual records for each clinical session.
...
connect to SNOMED-CT, in order to enable semantic interoperability with existing systems.
