...
Existing approaches to electronic integrated health records have largely focused on centralised information architectures, where patient data is held in a single repository, and accessed over the internet. Many patients are wearing personal sensors that report high-frequency and high-resolution data about their lifestyle, which could benefit patients and clinicians when taken in clinical context. We present an architecture that enables electronic health records to be augmented with activity diaries from personal sensors, and shared between patients and clinicians, to enhance communication and understanding about a patient's condition and how lifestyle changes can improve their situation.
